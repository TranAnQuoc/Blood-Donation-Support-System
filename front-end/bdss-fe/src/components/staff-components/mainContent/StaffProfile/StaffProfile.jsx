...
import styles from './StaffProfile.module.css'; // CSS riêng cho StaffProfile
...
const StaffProfile = () => {
    ...
    const fetchProfile = useCallback(async () => {
        ...
        try {
            ...
            console.log("Loaded Staff Profile:", fetchedProfile);
        } catch (err) {
            console.error("Lỗi khi tải profile Staff:", err);
    ...
    const handleSave = async () => {
        ...
        try {
            const dataToSend = {
                ...
                statusDonation: editData.statusDonation || profile.statusDonation || 'INACTIVE',
            };
    ...
    if (loading) {
        return <div className={styles.loadingMessage}>Đang tải profile Staff...</div>;
    }
