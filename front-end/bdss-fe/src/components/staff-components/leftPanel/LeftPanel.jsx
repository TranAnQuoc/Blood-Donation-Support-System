...
const LeftPanel = () => {
    ...
    const navItems = [
        ...
        { id: 'process', icon: faBook, label: 'Quản Lý Quá Trình', hasDropdown: true },
        { id: 'history', icon: faHistory, label: 'Quản Lý Lịch Sử', hasDropdown: true },
        ...
        { id: 'bloodStorageHistory', icon: faHistory, label: 'Lịch Sử Kho Máu', fullPath: '/staff-dashboard/blood-storage-history' },
