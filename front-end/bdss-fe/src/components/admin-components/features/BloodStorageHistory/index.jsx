                ...
                <Modal onClose={handleCloseModal}>
                    <div className={styles.modalContent}>
                        ...
                        <div className={styles.detailRow}>
                            ...
                            >
                                {BloodStorageHistoryStatus[selectedRecord.bloodStatus]?.replace(/_/g, " ")}
                            </span>
                        </div>
                        <div className={styles.detailRow}>
                            <p>
                        ...
                        {selectedRecord.verifiedAt && (
                            <>
                                ...
                                <div className={styles.detailRow}>
                                    ...
                                    <span 
                                        className={`${styles.statusBadge} ${styles[selectedRecord.verifiedStatus?.toLowerCase()]}`}
                                    >
                                        {VerifiedStatus[selectedRecord.verifiedStatus]?.replace(/_/g, " ") || "N/A"}
                                    </span>
                                </div>
                                <div className={styles.detailRow}>
                                    <p>
