...
public class DonationScheduleAPI {
    ...
    @PostMapping
    public ResponseEntity<DonationSchedule> create(@RequestBody DonationScheduleDTO schedule) {
    ...
    @PreAuthorize("hasRole('STAFF')")
    @PutMapping("/{id}")
    public ResponseEntity<DonationSchedule> update(@PathVariable Long id, @RequestBody DonationScheduleDTO schedule) {
